...
${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/test_player_move.exe: ${OBJECTFILES}
	...
	${LINK.c} -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/test_player_move ${OBJECTFILES} ${LDLIBSOPTIONS} -lpdcurses
...
${OBJECTDIR}/wall.o: wall.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -std=c11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/wall.o wall.c
